...
namespace Bitir.Mobile.Services
{
    public class ProvinceService : BaseService, IProvinceService
    {
        ...
        public async Task<ResponseWrapperListing<Province>> GetProvince(Province request)
        {
            ...
            var restResponse = await restClientRequest.Item1.ExecuteAsync<ResponseWrapperListing<Province>>(restClientRequest.Item2);
